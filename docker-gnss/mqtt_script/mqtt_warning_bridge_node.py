...
def on_connect(client, userdata, flags, rc, properties=None):
    if rc == 0:
        ...
        warning_topic = "pedestrian/warning" # <-- REPLACE THIS VALUE
...
client.username_pw_set("Teinvein", "AvvxbbVF_SATe8P")
# connect to HiveMQ Cloud on port 8883 (default for MQTT)
client.connect("433cc2cac2e94209844da1e0eab9abdf.s1.eu.hivemq.cloud", 8883)
